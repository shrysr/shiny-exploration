...
- Note taken on [2019-02-06 Wed 10:17] \\
  With wget : -P is the flag for the prefix directory for the file being downloaded. The path will be created if it does not exist. If the file already exists, a duplicate will be created with the '.1' suffix.
